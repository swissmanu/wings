...
define(function(require, exports, module) {
	...
	var CanvasWrapper = function CanvasWrapper(canvas) {
		 ...
		 */
		_self.on('drawRequest', function(widget, path) {
		 ...
		 */
		_self.on(['widgetAdded','widgetRemoved','childAddedWidget','childRemovedWidget'], function(widget, path) {
			prepareSearchBoost();
		});
		 ...
		 * Creates a <DefaultStrategy> and attaches a "startDrag" event
		...
		function createDefaultStrategy() {
			...
			defaultStrategy.on('startDrag', function handleStartDrag(absolutePosition) {
		 ...
		 * Creates a <DragAndDropStrategy> and attaches a "stopDrag" event
		 * listener to it. As soon as the event gets detected, the <CanvasWrapper>s
		...
		function createDragAndDropStrategy() {
			...
			dragAndDropStrategy.on('stopDrag', function handleStopDrag(absolutePosition) {
