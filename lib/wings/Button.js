...
define(function(require, exports, module) {
	...
	var Button = function Button(text) {
		...
		/** Event Handler: mouse:down, mouse:up
		 * Reacts on mouse:down and mouse:up events by redrawing the <Button>
		 * with proper visual representation.
		 */
		_self.on(['mouse:down','mouse:up'], function(e) {
			_mouseDown = (e.name === 'mouse:down');
			_self.redraw();
		});
